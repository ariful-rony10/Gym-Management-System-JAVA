 ...
 * @author airon
 */
public class pre_rename extends javax.swing.JFrame {
...
// Close the connection object  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pre_rename.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pre_rename().setVisible(true);
            }
        });
    }
